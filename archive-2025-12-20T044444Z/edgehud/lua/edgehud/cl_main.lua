...
--Base (REDUCIDO PARA HUD MÁS PEQUEÑO)
EdgeHUD.Vars.WidgetHeight = math.floor(screenHeight * 0.04)  -- era 0.05
EdgeHUD.Vars.ScreenMargin = math.floor(screenHeight * 0.01)  -- era 0.012
EdgeHUD.Vars.ElementsMargin = math.floor(screenHeight * 0.008)  -- era 0.01
...
--cl_lowerleft (REDUCIDO PARA HUD MÁS PEQUEÑO)
EdgeHUD.Vars.statusWidgetWidth = math.floor(EdgeHUD.Vars.hungerMod and screenHeight * 0.07 or screenHeight * 0.11)  -- era 0.088 y 0.138
...
--cl_topleft (REDUCIDO PARA HUD MÁS PEQUEÑO)
EdgeHUD.Vars.salaryWidgetWidth = math.floor(screenHeight * 0.09)  -- era 0.11
EdgeHUD.Vars.moneyWidgetWidth = math.floor(screenHeight * 0.12)  -- era 0.15
...
EdgeHUD.Vars.toprightWidth = math.floor(screenHeight * 0.35)  -- era 0.43

--Create a variable that holds the width for the elements in the lower right.
EdgeHUD.Vars.extraWidgetsWidth = screenHeight * 0.11  -- era 0.14
...
EdgeHUD.Vars.voteWindowHeight = screenHeight * 0.14  -- era 0.175
