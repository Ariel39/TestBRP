...
PreLoadFile(path .. "/client/", "minigame.lua", false, false, true)
PreLoadFile(path .. "/shared/", "minigame_networking.lua", false, true, true)
PreLoadFile(path .. "/client/", "medic_hud.lua", false, false, true)  -- ← NUEVA LÍNEA
PreLoadFile(path .. "/client/", "medic_patient_cache.lua", false, false, true)  -- ← NUEVA
