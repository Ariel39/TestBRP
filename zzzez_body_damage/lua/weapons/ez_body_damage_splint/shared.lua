...
SWEP.WorldModel         = "models/easzy/ez_body_damage/splint/w_splint.mdl"
SWEP.ViewModel          = "models/easzy/ez_body_damage/splint/v_splint.mdl"
...
SWEP.Primary.ClipSize = easzy.bodydamage.config.maxStackSplint
