...
function SWEP:PrimaryAttack(bodyPart)
    ...
    local bodyPart = bodyPart or easzy.bodydamage.GetMostInjuredBodyPart(owner, "bleeding")
...
function SWEP:SecondaryAttack()
    ...
    -- Verify that there is something to treat
    local bodyPart = bodyPart or easzy.bodydamage.GetMostInjuredBodyPart(ent, "bleeding")
    if not bodyPart then return end
