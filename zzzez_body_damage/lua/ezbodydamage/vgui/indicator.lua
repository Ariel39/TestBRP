...
function PANEL:Paint(w, h)
    ...
    local percentageText = percentage .. "%"  -- Convertir a string ANTES de GetTextSize
    local font = "EZFont20"  -- Actualizado de EZFont16 a EZFont20
    surface.SetFont(font)
    local percentageW, percentageH = surface.GetTextSize(percentageText)  -- Ahora usa el string
    ...
    draw.SimpleText(percentageText, font, w/2, h - percentageH/2, easzy.bodydamage.colors.white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
